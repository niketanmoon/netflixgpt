      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(user, {
            ...
            photoURL: "https://avatars.githubusercontent.com/u/25257427?v=4",
          })
            .then(() => {
              console.log(auth);
  ...
  return (
    <div>
      ...
      <form
        ...
        className="absolute p-12 bg-black/70 w-4/12 my-36 mx-auto right-0 left-0 text-white rounded-lg"
      >
